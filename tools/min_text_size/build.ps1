# build.ps1 — configure + build the host min_text_size tool with MSVC + Ninja.
#
# Usage:  pwsh build.ps1
# Then:   .\build\min_text_size.exe <font.otf> [pixelCriterion=1.0] [rasterEmPx=512]
#
...
Write-Host "`nmin_text_size built: $(Join-Path $build 'min_text_size.exe')"
